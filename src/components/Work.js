...
const Work = () => {
  return (
    <section className=" mx-auto w-[80%] p-8">
      <div>
        <div className="flex flex-row w-full space-x-[200px] justify-center  border-2 ">
          {/* first */}
          <div className="flex justify-start flex-col items-start space-y-6 pb-64">
            ...
            <div className="flex  flex-col group items-center space-y-8 bg-gray-300 p-4">
              {/* img */}
              <div className=" transition-all duration-200 relative bg-netflix bg-center saturate-0 group-hover:saturate-200 bg-no-repeat p-[400px] bg-cover  rounded-[80px] group-hover:rounded-tr-[300px]  ">
            ...
            <div className="flex flex-col group  items-center space-y-8 bg-gray-300 p-4">
              {/* img */}
              <div className=" transition-all duration-200 rounded-[80px] relative bg-redbull saturate-0 group-hover:saturate-200   bg-center bg-no-repeat p-[400px] bg-cover  group-hover:rounded-tr-[300px] ">
                                <div className='absolute flex justify-center items-center top-0 right-0 h-[180px] w-[180px] border-gray-300  border-[10px]  rounded-full bg-[#B9E901]  invisible group-hover:visible 
                                transition-all duration-200 transform group-hover:translate-x-4 group-hover:-translate-y-4'>
                  <BsArrowUpRight className='w-[75px] h-[75px]   text-[#601FEB]'></BsArrowUpRight>
          ...
          <div className="flex flex-col justify-start items-end space-y-6 pt-64">
            ...
            <div className="flex flex-col group  items-center space-y-8 bg-gray-300 p-4">
              {/* img */}
              <div className=" transition-all duration-200 bg-cola relative saturate-0 group-hover:saturate-200  group-hover:rounded-tr-[300px]  rounded-[80px] bg-center bg-no-repeat p-[400px] bg-cover">
                                <div className='absolute flex justify-center items-center top-0 right-0 h-[180px] w-[180px] border-gray-300  border-[10px]  rounded-full bg-[#B9E901]  invisible group-hover:visible 
                                transition-all duration-200 transform group-hover:translate-x-4 group-hover:-translate-y-4'>
                  <BsArrowUpRight className='w-[75px] h-[75px]   text-[#601FEB]'></BsArrowUpRight>
            ...
            <div className="flex flex-col group items-center space-y-8 bg-gray-300 p-4">
              {/* img */}
              <div className=" transition-all duration-200 bg-benz relative saturate-0 group-hover:saturate-200  group-hover:rounded-tr-[300px]  rounded-[80px] bg-center bg-no-repeat p-[400px] bg-cover">
                                <div className='absolute flex justify-center items-center top-0 right-0 h-[180px] w-[180px] border-gray-300  border-[10px]  rounded-full bg-[#B9E901]  invisible group-hover:visible 
                                transition-all duration-200 transform group-hover:translate-x-4 group-hover:-translate-y-4'>
                  <BsArrowUpRight className='w-[75px] h-[75px]   text-[#601FEB]'></BsArrowUpRight>
